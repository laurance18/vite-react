    ...
    return (
        <div>
            <div className="card--container flex flex-row p-12 gap-8 flex-wrap md:flex-nowrap">
                <img src={props.imgURL} alt={props.location} className='md:w-[320px] md:h-full max-w-full h-auto rounded-lg hover:scale-[1.02] hover:shadow-md duration-500 transition-all aspect-video'/>
