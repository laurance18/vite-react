export default function Card(props) {
    return (
        <div>
            <div className="card--container flex flex-row p-12 gap-8 flex-wrap ">
                <img src={props.imgURL} alt={props.location} className='max-w-xs h-auto w-full object-fill rounded-lg hover:scale-[1.02] hover:shadow-md duration-500 aspect-video'/>
